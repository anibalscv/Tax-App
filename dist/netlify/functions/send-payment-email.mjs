...
// netlify/functions/send-payment-email.mts
var send_payment_email_default = async (req, context) => {
  if (req.method !== "POST") {
...
<head>
  ...
  <title>Confirmaci\xF3n de Pago \u2013 TaxFlow</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#4f46e5 0%,#7c3aed 100%);padding:40px 40px 32px;text-align:center;">
              ...
              <h1 style="margin:0;color:#ffffff;font-size:26px;font-weight:700;letter-spacing:-0.5px;">\xA1Pago Confirmado!</h1>
              <p style="margin:8px 0 0;color:rgba(255,255,255,0.85);font-size:15px;">Tu obligaci\xF3n tributaria ha sido procesada exitosamente</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px 40px 0;">
              <p style="margin:0;color:#334155;font-size:16px;">Hola, <strong>${name}</strong> \u{1F44B}</p>
              <p style="margin:12px 0 0;color:#64748b;font-size:15px;line-height:1.6;">
                Te confirmamos que tu pago ha sido procesado con \xE9xito. A continuaci\xF3n encontrar\xE1s el resumen de tu transacci\xF3n.
              </p>
            </td>
          </tr>
                ...
                <tr>
                  <td style="padding:0;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding:14px 24px;border-bottom:1px solid #e2e8f0;">
                          <span style="color:#64748b;font-size:14px;">Per\xEDodo</span>
                        </td>
                        <td style="padding:14px 24px;border-bottom:1px solid #e2e8f0;text-align:right;">
                      ...
                      <tr>
                        <td style="padding:14px 24px;border-bottom:1px solid #e2e8f0;">
                          <span style="color:#64748b;font-size:14px;">N\xB0 de Transacci\xF3n</span>
                        </td>
                        <td style="padding:14px 24px;border-bottom:1px solid #e2e8f0;text-align:right;">
          ...
          <tr>
            <td style="background:#f8fafc;border-top:1px solid #e2e8f0;padding:24px 40px;text-align:center;">
              <p style="margin:0;color:#94a3b8;font-size:13px;line-height:1.5;">
                Este es un correo autom\xE1tico generado por <strong style="color:#64748b;">TaxFlow</strong>.<br />
                Si no reconoces este pago, cont\xE1ctanos de inmediato.
              </p>
              <p style="margin:12px 0 0;color:#cbd5e1;font-size:12px;">
                \xA9 ${(/* @__PURE__ */ new Date()).getFullYear()} TaxFlow. Todos los derechos reservados.
              </p>
            </td>
          </tr>
...
export {
  config,
  send_payment_email_default as default
};
